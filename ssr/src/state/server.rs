...
impl AppState {
    ...
    pub async fn new(conf: AppConfig, leptos_options: LeptosOptions, routes: Vec<RouteListing>) -> Self {
        Self {
            leptos_options,
            routes,
...
fn fallback_cookie_key() -> [u8; 64] {
    ...
    [
        18, 103, 178, 145,  80,   3, 101, 196,  32,  67, 224,
        75, 198, 156, 242,  74,  49,  73,  91, 216, 147, 111,
        200, 214, 121,  66, 131, 103,  94,  40, 143, 173, 117,
        89, 113, 146,  45,  69, 207,  28, 160, 180,  56, 223,
        79, 200,  71, 243, 156, 176, 178, 172, 235,  58,  69,
        103,  62, 255,  35,  28, 221, 184, 141, 201
    ]
}
